...
class LeetCodeProfile extends StatelessWidget {
      ...
      body: SingleChildScrollView(
          child: Padding(
              padding: const EdgeInsets.only(
                  left: 400, right: 400, top: 30, bottom: 30),
              child: Container(
  ...
  Widget _buildProfileSection() => Row(children: [
        const CircleAvatar(
            radius: 30,
        ...
        Expanded(
          ...
          const Text('Rank ~5,000,000', style: TextStyle(color: Colors.grey)),
  ...
  Widget _buildStatsSection() => SizedBox(
      height: 150,
  ...
  Widget _buildStatRow(IconData icon, String label, String value) => Padding(
  ...
  Widget _buildSkillRow(String level, Color color) => Padding(
      padding: const EdgeInsets.symmetric(vertical: 4.0),
      child: Row(children: [
  ...
  Widget _buildRecentSubmissionsSection() =>
      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        const Center(
          ...
          Text('No recent submissions', style: TextStyle(color: Colors.grey))
        ]))
      ]);
}
