  ...
  Widget _buildCodeLine(String text, {bool isOutput = false}) {
    return Container(
      padding: const EdgeInsets.symmetric(
          vertical: 4, horizontal: 10), // Reduced vertical from 6
      margin: const EdgeInsets.only(bottom: 4), // Reduced from 6
      decoration: BoxDecoration(
        color: isOutput ? Colors.green.shade50 : Colors.white,
        borderRadius: BorderRadius.circular(6),
        border: Border.all(
          color: isOutput ? Colors.green.shade100 : Colors.grey.shade200,
        ),
      ),
      child: Text(
        text,
