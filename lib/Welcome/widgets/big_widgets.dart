  ...
  return SliverAppBar(
      ...
      flexibleSpace: FlexibleSpaceBar(
          ...
          title: Row(children: [
            ...
            const Text('Competitive Coding Arena',
                style: TextStyle(
                    color: Colors.white,
...
Widget buildIntroSection(AnimationController controller1) => SliverToBoxAdapter(
    child: Center(
        child: Padding(
            ...
            child: Row(
                ...
                children: [
                  _buildAnimatedImage(
                      controller1,
                      'https://thisismybucketiambatman123456.s3.ap-south-1.amazonaws.com/DO_NOT_DELETE/data.png',
                      350),
                  buildInfoContainer(
                      'A New Way to Learn',
...
Widget buildWhycompetitivecodingarenaSection() => SliverToBoxAdapter(
      child: Center(
...
Widget buildCompaniesSection() => SliverToBoxAdapter(
      child: Center(
        child: Padding(
          padding: const EdgeInsets.symmetric(vertical: 100.0),
          child: buildSectionContainer(
...
Widget _buildAnimatedImage(
        AnimationController controller, String network, double width) =>
    AnimatedBuilder(
        ...
        child: Image.network(network, width: width));
